...
appointmentsRouter.get('/', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
...
appointmentsRouter.post('/', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, provider_id, date, parsedDate, createAppointment, appointment;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body, provider_id = _a.provider_id, date = _a.date;
